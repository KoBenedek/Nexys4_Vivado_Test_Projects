...
HD_PWD='D:/Documents/Motorvezerlo ASIC tervezes/FPGA programozas/Vivado projektek/Nexys4_Vivado_Test_Projects/test_project_1_blinky/test_project_1_blinky.runs/synth_1'
cd "$HD_PWD"
